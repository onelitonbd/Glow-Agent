...
- [Neural Ink settings-page design](settings-page.html) — the first dedicated settings screen. The sidebar Settings route now opens this page.
- `design-previews/` — PNG previews for Neural Ink / Focus Chat, Iris Signal / Agent Run, Paper Circuit / Skills & Tools, the selected [Neural Ink chat page](design-previews/neural-ink-chat-page.png), its [chat-history drawer](design-previews/neural-ink-chat-history.png), and [settings page](design-previews/neural-ink-settings-page.png).
